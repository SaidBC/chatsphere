      ...
      <div className="max-w-6xl mx-auto">
        ...
        {isLoading && !showCreateModal ? (
          ...
          <div className="bg-gray-900 rounded-xl shadow-lg border border-gray-800 p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-300 mb-2">No chat rooms yet</h3>
            <p className="text-gray-400 mb-6">Create your first chat room to start connecting with others</p>
            <button
              onClick={() => setShowCreateModal(true)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 overflow-y-auto chat-scrollbar pr-2">
            {rooms.map((room) => (
              <div key={room.id} className="bg-gray-900 rounded-xl shadow-lg border border-gray-800 overflow-hidden hover:border-accent-1/50 transition-colors duration-200">
                <div className="p-6">
                ...
                <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-gradient-to-r from-accent-1/20 to-accent-2/20 sm:mx-0 sm:h-10 sm:w-10">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-accent-1" viewBox="0 0 20 20" fill="currentColor">
